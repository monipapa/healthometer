...
public class MeasurementSpecificationBuilder
    extends SpecificationBuilder<MeasurementEntity, MeasurementCriteria> {
              ...
              .and(
                  ((root, query, criteriaBuilder) ->
                      criteriaBuilder.equal(
                          root.get("userEntity").get("id"), criteria.getUserId())));
    }
      ...
      specification =
          Objects.requireNonNull(specification)
              .and(
                  ((root, query, criteriaBuilder) ->
                      criteriaBuilder.equal(
                          root.get("bodyMeasurementCategoryEntity").get("id"),
                          criteria.getBodyMeasurementCategoryId())));
    }
