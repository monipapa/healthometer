...
public class UnitCategoryController {
    ...
    @PostMapping
    public ResponseEntity<UnitCategoryEntity> save(@RequestBody @NotNull UnitCategoryDto unitCategoryDto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UnitCategoryEntity> update(@RequestBody UnitCategoryDto unitCategoryDto, @PathVariable Long id) {
        return new ResponseEntity<>(unitCategoryService.update(id, unitCategoryDto),HttpStatus.CREATED);
    }
