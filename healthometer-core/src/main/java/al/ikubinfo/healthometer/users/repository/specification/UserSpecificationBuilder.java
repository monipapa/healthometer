...
public class UserSpecificationBuilder extends SpecificationBuilder<UserEntity, UserCriteria> {
  ...
  public Specification<UserEntity> filter(UserCriteria criteria) {
    ...
    if (criteria.getFirstName() != null) {
      specification =
          Objects.requireNonNull(specification)
              .and(likeLowerCaseSpecification("firstName", criteria.getFirstName()));
    }

    if (criteria.getLastName() != null) {
      specification =
          Objects.requireNonNull(specification)
              .and(likeLowerCaseSpecification("lastName", criteria.getLastName()));
    }
    ...
    if (criteria.getEmail() != null) {
      specification =
          Objects.requireNonNull(specification)
              .and(likeLowerCaseSpecification("email", criteria.getEmail()));
    }
    if (criteria.getUsername() != null) {
      specification =
          Objects.requireNonNull(specification)
              .and(likeLowerCaseSpecification("username", criteria.getUsername()));
    }
