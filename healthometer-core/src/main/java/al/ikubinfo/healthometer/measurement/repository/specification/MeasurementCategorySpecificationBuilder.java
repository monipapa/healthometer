...
@Component
public class MeasurementCategorySpecificationBuilder extends SpecificationBuilder<MeasurementCategoryEntity, MeasurementCategoryCriteria> {
    @Override
        ...
        if (criteria.getUnitCategoryId() != null) {
            specification = Objects.requireNonNull(specification).and(
                    ((root, query, criteriaBuilder)
                            -> criteriaBuilder.equal(root.get("unitCategoryEntity").get("id"), criteria.getUnitCategoryId())));
        }
